...
Config.Shops = {
    ['pdm'] = {
        ...
        ['ShowroomVehicles'] = {
            [1] = {
                ...
                defaultVehicle = 'penumbra',                       -- Default display vehicle
                chosenVehicle = 'penumbra',                        -- Same as default but is dynamically changed when swapping vehicles
            },
            [2] = {
    ...
    ['air'] = {
        ...
        ['FinanceZone'] = vector3(-1620.49, -3151.78, 13.99),
        ['ShowroomVehicles'] = {
            [1] = {
